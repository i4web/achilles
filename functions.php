...
require_once locate_template ('lib/achilles-config.php');
require_once locate_template ('lib/achilles-cleanup.php');
require_once locate_template ('lib/achilles-customizer.php');		//Achilles Theme Customizer Class
?>